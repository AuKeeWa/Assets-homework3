...
namespace ModelController{
	...
	public class BoatModel{
		...
		public BoatModel(){
			boat = Object.Instantiate(Resources.Load("Prefabs/boat", typeof(GameObject)), new Vector3(2, 0, 0), Quaternion.identity) as GameObject;

			boat.name = "boat";
			move = boat.AddComponent(typeof(Move)) as Move;
			click = boat.AddComponent(typeof(Click)) as Click;
			click.SetBoat(this);
			start_empty_pos = new Vector3[] { new Vector3(2.75F, 1, 0), new Vector3(1.25F, 1, 0) };
			end_empty_pos = new Vector3[] { new Vector3(-1.25F, 1, 0),  new Vector3(-2.75F, 1, 0)};
		}
		...
		public void BoatMove(){
			if (boat_sign == -1){
				move.MovePosition(new Vector3(2, 0, 0));
				boat_sign = 1;
			}
			else{
				move.MovePosition(new Vector3(-2, 0, 0));
	...
	public class LandModel{
		...
		public LandModel(string land_mark){
			positions = new Vector3[] {new Vector3(12.5F,2F,0), new Vector3(11F,2F,0), new Vector3(9.5F,2F,0),
				new Vector3(8F,2F,0), new Vector3(6.5F,2F,0), new Vector3(5F,2F,0)};
			if (land_mark == "start"){
				land = Object.Instantiate(Resources.Load("Prefabs/Land", typeof(GameObject)), new Vector3(8.5f, 0, 0), Quaternion.identity) as GameObject;
				land_sign = 1;
			}
